...
| 2026-06-21T19:25:00Z    | Inicialización de frontend Next.js 14 + sistema de diseño SANTI. Conectadas 4 pantallas a datos reales del backend (catalogo, stock con Kardex y ajuste, pedidos/lotes con lista progresiva e historial, y taller con ciclo completo de OT, cobro del 80% y liberación). Pantallas facturacion y admin se mantienen en mock. Fix de binding de red (0.0.0.0) aplicado en package.json. Estado: PAUSADO por decisión de Sant, pendiente de aprobación formal de UI/UX (DOC-3) y AppFlow (DOC-4). · provisional_por_agente: true |
